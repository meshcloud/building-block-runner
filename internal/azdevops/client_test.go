...
func testClient(baseUrl string) adoClient {
	return newADOClient(baseUrl, "myorg", "myproj", "42", "the-pat", NewHTTPClient(0), meshapi.SlogLogger(nil))
}
...
func Test_BaseURL_NotSanitized(t *testing.T) {
	...
	c := newADOClient(srv.URL+"/", "myorg", "myproj", "42", "pat", NewHTTPClient(0), meshapi.SlogLogger(nil))
