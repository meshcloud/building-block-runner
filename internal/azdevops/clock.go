...
// Clock abstracts both the poller's 10s wait and its 30-min deadline so tests never
...
// (Thread.sleep itself was not injectable there) -- the Go port makes the wait
