...
// Test_MapStageStatus covers the full cross-product incl. the else-holes (completed+
...
// Test_MapStageUserMessage covers the else branch and the null-state message.
...
// Test_BuildStageSystemMessage covers all-fields, result-only, no-times, null-state.
