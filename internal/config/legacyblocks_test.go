...
// TestWarnIgnoredLegacyYAMLBlocks_WarnsOnSpringBlocks pins the P3.4 warn-on-ignore behavior:
...
// silently dropping it. Detection spans both merged layers.
...
func TestWarnIgnoredLegacyYAMLBlocks_SilentWhenAbsent(t *testing.T) {
	dir := t.TempDir()
	base := writeFile(t, dir, "base.yml", "name: clean\n")
