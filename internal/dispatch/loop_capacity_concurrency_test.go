...
// Test_Loop_NeverExceedsMaxConcurrentRuns pins concurrency hazard H6 (plan-05 §7): the
...
// window -- the "the loop stays at capacity, it does not over-claim" half of H6.
