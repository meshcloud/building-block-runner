...
// fakeStandaloneMetrics records the two additive standalone-type events Loop drives
...
// A nil Standalone (the run-controller type) must not panic at either hook site.
