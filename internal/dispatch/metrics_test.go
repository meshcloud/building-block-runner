...
// TestNewMetricsCollectorWithRegistry_IsolatesRegistries proves the injectable seam:
// two collectors built on two fresh registries do not share counters (so a
...
// method on the frozen run_controller_* series -- this is the surface internal/k8sjob
