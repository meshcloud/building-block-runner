...
// controller.reportRunFailure pattern (controller parity, PLAN_DETAIL_05 §8/§10.1).
...
// string, D9/D10) -- it must not change even though the message is now dispatcher-authored
...
// deliberately kept vague-but-frozen and one deliberately actionable; see PLAN_DETAIL_05
// §10.1/§16.4 for why they are not unified).
