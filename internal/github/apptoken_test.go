...
// Test_AppToken pins G-P1: the minted token has header {alg:RS256,typ:JWT}, claims exactly
...
// Test_ParseAppPem pins G-P2: the PKCS#1 tolerance table — multi-line, single-line and
