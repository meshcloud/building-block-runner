...
// TestLoadConfig_PollingMode_ResolvesBaseKey pins that the shared base layer's private
// key is used when no operator override exists (resolution order deferred to the
