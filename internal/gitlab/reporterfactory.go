...
// seam shape to the manual template (internal/manual/handler.go); kept here per type
// package rather than shared (each type's factory differs slightly in what it
...
// (identical pattern to internal/manual.NewReporterFactory).
