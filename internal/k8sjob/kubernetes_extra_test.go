		...
		Implementations: map[string]JobSpecTemplate{
			"MANUAL": {
				...
				Resources: ResourcesConfig{
					...
					Limits:   ResourceSpec{Cpu: "500m", Memory: "2Gi"},
				},
				ExtraVolumes: []ExtraVolume{
					{Name: "trusted-certs", ConfigMap: &ConfigMapVolumeSpec{Name: "certs-cm"}},
					{Name: "extra-secret", Secret: &SecretVolumeSpec{SecretName: "extra-secret-name"}},
					{Name: "scratch", EmptyDir: &EmptyDirVolumeSpec{SizeLimit: sizeLimit}},
				},
