...
// TestSingleRun_MissingPath pins the Go delta: no RUN_JSON_FILE_PATH ⇒ exit 1 (the
// deliberate tightening of the Kotlin exit-0 swallow).
...
// TestSingleRun_ReportFailure: a report transport failure ⇒ exit 1.
