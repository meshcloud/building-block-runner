...
// Pins the 128MiB plan-artifact download cap (client.go:20 maxArtifactBytes,
// client.go:153-159). The former same-origin check that used to accompany this cap was
// deliberately reverted in commit 88d67d4 and is NOT pinned — pinning a deleted feature
// would be impossible.
