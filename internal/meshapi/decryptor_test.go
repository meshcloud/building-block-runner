...
// algorithm the Kotlin MeshCertDecryptionService implements (umbrella A9): encrypt then
...
// TestCertDecryptor_EmptyString pins T8/G-P11: Kotlin's decrypt("") returns "" rather than
