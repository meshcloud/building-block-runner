...
// SourceUpdateDTO is the lean status-PATCH body the four phase-6 Kotlin-port runners
...
// controller's StatusUpdateDTO (umbrella §7.4, plan 06A §4.3). It mirrors the Kotlin
...
// with null treated as absent (06A §2.4/§16.4). The meshfed endpoint upserts steps by id,
...
// *string just to reproduce "field not sent" (P4 simple-nullable rule — "" already means
