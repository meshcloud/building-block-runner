...
// TestEventReporter_Register pins the wire shape: register the source id with one
...
// TestEventReporter_RegisterConflictTolerated: 409 on register = success.
...
// TestEventReporter_Report pins the lean SourceUpdate body and {sourceId}
