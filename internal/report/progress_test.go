...
// clone-under-lock design exists to prevent: one goroutine repeatedly mutates while
// another repeatedly snapshots. Run with -race to prove there is no data race.
